...
import com.example.android.meter.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private TextView mDateText, mTimeText, mRepeatText, mRepeatTypeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepeatText.setText("Кожен " + " " + mRepeatType);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("Заголовок не може бути пустим!");
                }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        // for the postivie and negative buttons on the dialog.
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Видалити це нагадування ?");
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText( this, "Нагадування видалено",
                        Toast.LENGTH_SHORT).show();
            }
        }
...
*/
        ...
        // Check repeat type
        if (mRepeatType.equals("День")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
        } else if (mRepeatType.equals("Тиждень")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milWeek;
        } else if (mRepeatType.equals("Місяць")) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, "Нагадування збережено",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, "Нагадування змінено",
                        Toast.LENGTH_SHORT).show();
            }
        }
        ...
        if (mActive.equals("true")) {
            ...
            Toast.makeText(this, "Час нагадування : " + selectedTimestamp,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("Кожен " + " " + repeatType);
            // Setup up active buttons
            // Setup repeat switch
