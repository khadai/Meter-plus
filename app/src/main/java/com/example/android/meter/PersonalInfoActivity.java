...
public class PersonalInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aGCode = findViewById(R.id.actual_g_code);
        aGCode.setText(sharedPref.getString("GCode", "Не вказаний"));

        aWCode = findViewById(R.id.actual_w_code);
    ...
    public void changeActualName(View view) {
        ...
        button = findViewById(R.id.change_name);
    ...
    public void changeActualECode(View view) {
        ...
        dialog = new AlertDialog.Builder(this).create();
        editText = new EditText(this);
        button = findViewById(R.id.change_e_code);
    ...
    public void changeActualGCode(View view) {
        ...
        dialog = new AlertDialog.Builder(this).create();
        editText = new EditText(this);
        button = findViewById(R.id.change_g_code);
    ...
    public void changeActualWCode(View view) {
        ...
        dialog = new AlertDialog.Builder(this).create();
        editText = new EditText(this);
        button = findViewById(R.id.change_w_code);
